...
def main():
    ...
    # ================= Left window ========================
    f1 = Frame(bd=5, relief=SUNKEN, height=500, width=495, bg='red', highlightbackground="#8293ee",
               highlightcolor="#8293ee", highlightthickness=5)
    # ====== Logo and name =======  
    ...
    btn1 = Button(f1, bg='white', fg="red", relief="raised", bd=8, text='Customer Service', font=('Arial', 15, 'bold'),
                  command=cs, width=15).place(x=150, y=190)
    btn2 = Button(f1, bg='white', fg="red", relief="raised", bd=8, text='Payment', font=('Arial', 15, 'bold'),
                  command=Payment, width=15).place(x=150, y=250)
    btn3 = Button(f1, bg='white', fg="red", relief="raised", bd=8, text='Billing', font=('Arial', 15, 'bold'),
                  command=Billing, width=15).place(x=150, y=310)
    # ====== Priority number ========
    ...
    btn4 = Button(text='Confirm', font=('Arial', 15, 'bold'), command=Process, bg='white', fg="red", relief="raised",
                  bd=5).place(x=360, y=415)
    # ================= Right window ========================
    f2 = Frame(bd=5, bg='red', highlightbackground="#8293ee", highlightcolor="#8293ee", highlightthickness=5,
               height=500, width=500, relief="sunken")
    f2.place(x=490, y=0)
    # ======== Windows ============
    ...
    n1 = Button(bg='white', fg="red", relief="raised", bd=4, text='Next', font=('Arial', 15, 'bold'),
                command=Win1Next).place(x=520, y=420)
    n2 = Button(bg='white', fg="red", relief="raised", bd=4, text='Next', font=('Arial', 15, 'bold'),
                command=Win2Next).place(x=610, y=420)
    n3 = Button(bg='white', fg="red", relief="raised", bd=4, text='Next', font=('Arial', 15, 'bold'),
                command=Win3Next).place(x=700, y=420)
    close = Button(bg='#530023', fg="white", text='Exit', font=('Arial', 15, 'bold'), command=Exit, justify="center",
                   bd=5, relief="raised").place(x=880, y=420)
    reset = Button(bg='#530023', fg="white", text='Reset', font=('Arial', 15, 'bold'), command=Reset, justify="center",
                   bd=5, relief="raised").place(x=800, y=420)
    screen1.mainloop()
